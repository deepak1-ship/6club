...
function cownDownTimer() {
    var countDownDate = new Date("2030-07-16T23:59:59.9999999+00:00").getTime();
    setInterval(function () {
        ...
        let interval = 1;
        if(checkID == 5) interval = 3;
        if(checkID == 10) interval = 5;
        
        var minute = Math.ceil(minutes % interval);

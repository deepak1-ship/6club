...
const userInfo = async (req, res) => {
  ...
  return res.status(200).json({
    ...
    data: {
      ...
      lastLoginTime: formatLastLogin(time),
    },
...
const constructTransactionsQuery = (
  ...
  const queries = {
    ...
    "Recharge": {
      query: `SELECT id_order AS id, money, 'positive' AS type, 'Deposit' AS name, time FROM recharge WHERE phone = ? AND status = 1 AND time >= ? AND time <=?`,
    ...
    "Cancel withdrawal": {
      query: `SELECT id_order AS id, money, 'positive' AS type, 'Cancel withdrawal' AS name, time FROM withdraw WHERE phone = ? AND status = 2 AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM withdraw WHERE phone = ? AND status = 2 AND time >= ? AND time <=?`,
    },
    "Withdrawal rejected": {
      query: `SELECT id_order AS id, money, 'positive' AS type, 'Withdrawal rejected' AS name, time FROM withdraw WHERE phone = ? AND status = 3 AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM withdraw WHERE phone = ? AND status = 3 AND time >= ? AND time <=?`,
    },
    "Manual deposit": {
      query: `SELECT id_order AS id, money, 'positive' AS type, 'Manual deposit' AS name, time FROM recharge WHERE phone = ? AND status = 1 AND type = 'manual' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM recharge WHERE phone = ? AND status = 1 AND type = 'manual' AND time >= ? AND time <=?`,
    },
    "Manual withdrawal": {
      query: `SELECT id_order AS id, money, 'negative' AS type, 'Manual withdrawal' AS name, time FROM withdraw WHERE phone = ? AND status = 1 AND type = 'manual' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM withdraw WHERE phone = ? AND status = 1 AND type = 'manual' AND time >= ? AND time <=?`,
    },
    "USDT deposit": {
      query: `SELECT id_order AS id, money, 'positive' AS type, 'USDT deposit' AS name, time FROM recharge WHERE phone = ? AND status = 1 AND type = 'usdt' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM recharge WHERE phone = ? AND status = 1 AND type = 'usdt' AND time >= ? AND time <=?`,
    },
    "Deposit Gift": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Deposit Gift' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Deposit Gift' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Deposit Gift' AND time >= ? AND time <=?`,
    },
    ...
    "Attendance bonus": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Attendance bonus' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Attendance bonus' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Attendance bonus' AND time >= ? AND time <=?`,
    },
    "Agent's red envelope": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Agent red envelope' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Agent red envelope' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Agent red envelope' AND time >= ? AND time <=?`,
    },
    "Sign up bonus": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Sign up bonus' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Sign up bonus' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Sign up bonus' AND time >= ? AND time <=?`,
    },
    "Bonus": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Bonus' AS name, time FROM claimed_rewards WHERE phone = ? AND type LIKE '%Bonus%' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type LIKE '%Bonus%' AND time >= ? AND time <=?`,
    },
    "First deposit bonus": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'First deposit bonus' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'First deposit bonus' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'First deposit bonus' AND time >= ? AND time <=?`,
    },
    "First deposit rebate": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'First deposit rebate' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'First deposit rebate' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'First deposit rebate' AND time >= ? AND time <=?`,
    },
    "Mission rewards": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Mission rewards' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Mission rewards' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Mission rewards' AND time >= ? AND time <=?`,
    },
    "Bank binding bonus": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Bank binding bonus' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Bank binding bonus' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Bank binding bonus' AND time >= ? AND time <=?`,
    },
    "Betting rebate": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Betting rebate' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Betting rebate' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Betting rebate' AND time >= ? AND time <=?`,
    },
    "VIP level up reward": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'VIP level up reward' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'VIP level up reward' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'VIP level up reward' AND time >= ? AND time <=?`,
    },
    "VIP monthly reward": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'VIP monthly reward' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'VIP monthly reward' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'VIP monthly reward' AND time >= ? AND time <=?`,
    },
    "VIP deposit bonus": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'VIP deposit bonus' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'VIP deposit bonus' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'VIP deposit bonus' AND time >= ? AND time <=?`,
    },
    "One-Click rebate": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'One-Click rebate' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'One-Click rebate' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'One-Click rebate' AND time >= ? AND time <=?`,
    },
    "Bind mobile phone rewards": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Bind mobile phone rewards' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Bind mobile phone rewards' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Bind mobile phone rewards' AND time >= ? AND time <=?`,
    },
    "Bind email rewards": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Bind email rewards' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Bind email rewards' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Bind email rewards' AND time >= ? AND time <=?`,
    },
    "Weekly Award": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Weekly Award' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Weekly Award' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Weekly Award' AND time >= ? AND time <=?`,
    },
    "Daily rewards": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Daily rewards' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Daily rewards' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Daily rewards' AND time >= ? AND time <=?`,
    },
    "Turntable Awards": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Turntable Awards' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Turntable Awards' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Turntable Awards' AND time >= ? AND time <=?`,
    },
    "Partner rewards": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Partner rewards' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Partner rewards' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Partner rewards' AND time >= ? AND time <=?`,
    },
    "Tournament Rewards": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Tournament Rewards' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Tournament Rewards' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Tournament Rewards' AND time >= ? AND time <=?`,
    },
    "Return Awards": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Return Awards' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Return Awards' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Return Awards' AND time >= ? AND time <=?`,
    },
    "New members receive bonuses on their first deposit loss": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'First deposit loss bonus' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'First deposit loss bonus' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'First deposit loss bonus' AND time >= ? AND time <=?`,
    },
    "New members get bonuses by playing games": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'New member game bonus' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'New member game bonus' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'New member game bonus' AND time >= ? AND time <=?`,
    },
    "Join channel rewards": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Join channel rewards' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Join channel rewards' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Join channel rewards' AND time >= ? AND time <=?`,
    },
    "Invite Wheel Reward": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Invite Wheel Reward' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Invite Wheel Reward' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Invite Wheel Reward' AND time >= ? AND time <=?`,
    },
    "Newbie gift pack": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Newbie gift pack' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Newbie gift pack' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Newbie gift pack' AND time >= ? AND time <=?`,
    },
    "Withdrawal Reward": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Withdrawal Reward' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Withdrawal Reward' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Withdrawal Reward' AND time >= ? AND time <=?`,
    },
    "Bonus deduction": {
      query: `SELECT time AS id, amount AS money, 'negative' AS type, 'Bonus deduction' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Bonus deduction' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Bonus deduction' AND time >= ? AND time <=?`,
    },
    "ARPay Cash Back": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'ARPay Cash Back' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'ARPay Cash Back' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'ARPay Cash Back' AND time >= ? AND time <=?`,
    },
    "Recharge Replenishment": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Recharge Replenishment' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Recharge Replenishment' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Recharge Replenishment' AND time >= ? AND time <=?`,
    },

    // ==================== GAME TRANSACTIONS ====================
    "Game moved in": {
      query: `SELECT time AS id, amount AS money, 'negative' AS type, 'Game moved in' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Game moved in' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Game moved in' AND time >= ? AND time <=?`,
    },
    "Game moved out": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Game moved out' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Game moved out' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Game moved out' AND time >= ? AND time <=?`,
    },
    "Winning slots": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Winning slots' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Winning slots' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Winning slots' AND time >= ? AND time <=?`,
    },
    "Game refunded": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Game refunded' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Game refunded' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Game refunded' AND time >= ? AND time <=?`,
    },
    "Slots Jackpot": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Slots Jackpot' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Slots Jackpot' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Slots Jackpot' AND time >= ? AND time <=?`,
    },
    "XOSO issue canceled": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'XOSO issue canceled' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'XOSO issue canceled' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'XOSO issue canceled' AND time >= ? AND time <=?`,
    },

    // ==================== C2C TRANSACTIONS ====================
    "C2C Withdraw Awards": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'C2C Withdraw Awards' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'C2C Withdraw Awards' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'C2C Withdraw Awards' AND time >= ? AND time <=?`,
    },
    "C2C Withdraw": {
      query: `SELECT time AS id, amount AS money, 'negative' AS type, 'C2C Withdraw' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'C2C Withdraw' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'C2C Withdraw' AND time >= ? AND time <=?`,
    },
    "C2C Withdraw Back": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'C2C Withdraw Back' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'C2C Withdraw Back' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'C2C Withdraw Back' AND time >= ? AND time <=?`,
    },
    "C2C Recharge": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'C2C Recharge' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'C2C Recharge' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'C2C Recharge' AND time >= ? AND time <=?`,
    },
    "C2C Recharge Awards": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'C2C Recharge Awards' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'C2C Recharge Awards' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'C2C Recharge Awards' AND time >= ? AND time <=?`,
    },

    // ==================== FINANCIAL ====================
    "Investment and financial management": {
      query: `SELECT time AS id, amount AS money, 'negative' AS type, 'Investment' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Investment' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Investment' AND time >= ? AND time <=?`,
    },
    "Financial income": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Financial income' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Financial income' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Financial income' AND time >= ? AND time <=?`,
    },
    "Financial capital": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Financial capital' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Financial capital' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Financial capital' AND time >= ? AND time <=?`,
    },
    "Capital": {
      query: `SELECT time AS id, amount AS money, 'positive' AS type, 'Capital' AS name, time FROM claimed_rewards WHERE phone = ? AND type = 'Capital' AND time >= ? AND time <=?`,
      count: `SELECT COUNT(*) AS totalCount FROM claimed_rewards WHERE phone = ? AND type = 'Capital' AND time >= ? AND time <=?`,
    },
  };

  // Core queries to use for "All" filter - these don't rely on 'type' column filtering
  const coreQueryKeys = [
    "Bets", "trxBets", "Bet Win", "trxBet Win",
    "Recharge", "Withdraw", "Commissions",
    "Gift Vouchers", "Salary", "Claimed Rewards"
  ];

  if (filterType === "All") {
    // Construct combined queries using only core queries
    const selectedQueries = coreQueryKeys
      .filter(key => queries[key])
      .map((key) => `(${queries[key].query})`)
      .join(" UNION ALL ");

    const totalCountQueries = coreQueryKeys
      .filter(key => queries[key])
      .map((key) => `(${queries[key].count})`)
      .join(" + ");
    ...
    const params = coreQueryKeys
      .filter(key => queries[key])
      .flatMap(() => [phone, startDate, endDate]);
